#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Module contains warranty and acknowledgement for seal ROM.
...
"""
HEADER_0 = (" "*27) + "Warranty"
HEADER_1 = (" "*25) + "Disclaimer"
HEADER_COPYRIGHT = "    Copyright(c)2019-2022 by Ernest N. Lindner"
...
def show_warranty():
    ...
    for indx in range(2):
        ...
        # Clean text - revise statement to remove leading spaces and newlines.
